...
const team = [
  ...
  { initials: 'AM', 
    name: 'Alessandra', 
    tasks: ['UI Team and Logo creation', 'Terms of Service page', 'Routing', 'Advanced Feature - Review Interactive Timeline'], 
  ...
  { initials: 'TF', 
    name: 'Theodore', 
    tasks: ['Catalogue', 'Search & Filter', "API Implementation & Services"], 
